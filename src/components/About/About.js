...
export default class About extends React.Component {
    ...
    regForm = () => {
        ...
        }else{ this.setState({ showReg: 'true'})}
    }
            ...
            <div>
                <div className={this.state.showReg}>
                    <div className='regInputArea'>
                        <div className='regForm'>
                            <form>
                            <input autocomplete='on' type='text' placeholder='*name' required></input><br/>
                            <input autocomplete='on' type='email' placeholder='*email' required></input><br/>
                            <input autocomplete='on' type='tel' placeholder='(999)999-9999'></input><br/>
                            <input autocomplete='on' type='password' placeholder='*set password' required></input><br/>
                            <input autocomplete='on' type='password' placeholder='admin code?'></input><br/>
                            </form> 
                ...
                <div className='row1'>
                    ...
                    <div className="authArea">
                        ...
                        <button onClick={this.regForm}>register</button><br/>
                    </div>
